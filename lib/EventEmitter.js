...
class EventEmitter extends Emitter {
    ...
    constructor() {
        ...
        let parental = ['domain', '_events', '_eventsCount', '_maxListeners'];

        for (let i = 0, s = parental.length; i < s; i++) {
            let property = parental[i];
    ...
    /**
     * Safely destroys all events on this object
     */
    destroy() {
