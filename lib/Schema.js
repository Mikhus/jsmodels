...
const keywordValidators = {
    ...
    /**
     * Checks if a given 'validator' schema's property value is a valid
     * definition
     *
     * @param {*} value
     * @returns {boolean}
 ...
 */
cast.object = value => {
    if (value === Object || !value || Schema.typeOf(value) !== 'object') {
        return Object({});
    }
...
class Schema {
    ...
    /**
     * @property {Function} Schema.validator
     * @access public
     */
    ...
    constructor(definition, options = Schema.options, canonical = false,
                parent = null, name = '')
    {
        options = Object.assign({}, Schema.options, options);
...
Schema.isEmptyObject = isEmptyObject;
Schema.isPlainObject = isPlainObject;
