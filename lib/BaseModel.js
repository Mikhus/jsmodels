...
class BaseModel extends EventEmitter {
    ...
    link(driver, url, options) {
        this.channel = Channel.create(driver, url, options, this);
    ...
    /**
     * Loads a model by its identifier from a current synchronization channel.
     *
     * @param {string} id
     */
    fetch(id) {
    ...
    static fetch(id, driver, url, options) {
